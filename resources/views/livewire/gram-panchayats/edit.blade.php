<div>
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Edit Gram Panchayat</h1>
            <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Update gram panchayat information</p>
        </div>
