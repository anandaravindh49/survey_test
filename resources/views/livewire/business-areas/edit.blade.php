<div class="p-8">
    <div class="mb-8">
        ...
        <h1 class="text-4xl font-bold text-gray-900 dark:text-white mt-4">{{ __('Edit Business Area') }}</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-2">{{ $businessArea->business_name }}</p>
    </div>
